...
import ru.popkov.navigator.features.settings.nav.SettingsDestination
...
class SettingsNavProvider @Inject constructor(
    ...
    override val navBarItem = NavProvider.BottomBarItem(
        index = 3,
        labelResId = ru.popkov.navigator.features.settings.nav.R.string.settings_bottomnav_label,
